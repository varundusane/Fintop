...
class LoanForm(forms.ModelForm):
    ...
    liability_loan = forms.ChoiceField(label="Do you have any other additional liabilities ?", choices=yesorno,
                                       required=False)
    carloan_pay = forms.ChoiceField(label="If required, Can you pay off car loan immediately?", choices=yesorno,
                                    required=False)
    ...
    home_content = forms.CharField(max_length=50, required=True,
                                   label="Approximate value  of total home contains you may have ?")
    loans = forms.CharField(max_length=50, required=True, label="How much existing Mortgage loan you have currently?")
    annual_salary = forms.CharField(max_length=50, required=True,
                                    label="Annual Salary  (Indicate Combined Family Income)")
    monthly_expense = forms.CharField(max_length=50, required=True,
                                      label="Monthly Expense (Indicate Combined Family Expense)")
