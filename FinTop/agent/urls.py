...
from .views import SignUpView, SignUpVieww, login_agent, agent_dashboard, KycForm, underproccessedLoan
...
urlpatterns = [
    ...
    path('underproccessedLoan/', underproccessedLoan, name='underproccessedLoan')
