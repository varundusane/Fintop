...
class KYCForm(forms.ModelForm):
    ...
    email = forms.EmailField(max_length=300, label='Email Id')
    phone_regex = RegexValidator(regex=r'^\+?1?\d{9,15}$',
                                 message="Please enter valid phone number. Correct format is 04XXXXXXXX")
...
class KycFormsecondary(forms.ModelForm):
    name_of_Sdocument = forms.ChoiceField(label="Select the document for Police Verification",choices=secondary_document)
