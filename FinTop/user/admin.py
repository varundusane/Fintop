...
from .models import Referral, Loan, BankInfo, Profile, Additional_assets, Additional_liabilities, Verification, Contact, Business,Agent_Clients,Underprocess_loans,Incoming_loans,Completed_Loans
...
admin.site.register(Underprocess_loans)
admin.site.register(Incoming_loans)
admin.site.register(Agent_Clients)
admin.site.register(Completed_Loans)
@admin.register(User)
